// Test: options > importExtensions: ".js" rewrites relative imports to .js
//
// Spec:
// paths:
//   /users:
...
import type { ListUsers_Parameters, ListUsers_Response } from "./schemas.js";
import type { FetchApi } from "./fetch.js";
