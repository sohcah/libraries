...
export class Api {
  ...
  **/
  ...
  Multiple status values can be provided with comma separated strings.
  **/
  findPetsByStatusQuery(parameters: z.output<typeof FindPetsByStatus_Parameters> | SkipToken) {
    return queryOptions({
  ...
  **/
  ...
  Multiple tags can be provided with comma separated strings. Use tag1, tag2, tag3 for testing.
  **/
  findPetsByTagsQuery(parameters: z.output<typeof FindPetsByTags_Parameters> | SkipToken) {
    return queryOptions({
  ...
  **/
  ...
  Returns a single pet.
  **/
  getPetByIdQuery(parameters: z.output<typeof GetPetById_Parameters> | SkipToken) {
    return queryOptions({
  ...
  **/
  ...
  Returns a map of status codes to quantities.
  **/
  getInventoryQuery(parameters: z.output<typeof GetInventory_Parameters> | SkipToken) {
    return queryOptions({
  ...
  **/
  ...
  For valid response try integer IDs with value <= 5 or > 10. Other values will generate exceptions.
  **/
  getOrderByIdQuery(parameters: z.output<typeof GetOrderById_Parameters> | SkipToken) {
    return queryOptions({
  ...
  **/
  ...
  Log into the system.
  **/
  loginUserQuery(parameters: z.output<typeof LoginUser_Parameters> | SkipToken) {
    return queryOptions({
  ...
  **/
  ...
  Log user out of the system.
  **/
  logoutUserQuery(parameters: z.output<typeof LogoutUser_Parameters> | SkipToken) {
    return queryOptions({
  ...
  **/
  ...
  Get user detail based on username.
  **/
  getUserByNameQuery(parameters: z.output<typeof GetUserByName_Parameters> | SkipToken) {
    return queryOptions({
...
export const GetInventory_Response = z.codec(z.instanceof(Response), z.record(z.string(), z.int()), {
  decode: async (from, ctx) => {
    try {
      return (await from.json()) as any;
    } catch (error: unknown) {
